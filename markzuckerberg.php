...
<body style="background-color: rgb(3, 60, 100); color: white;">
    <main>
    <div class="text">
        <div class="title-mark">
            <center><h1>Mark Zuckerberg</h1></center>
            <center><h3>Raphael Barcelos</h3></center>
            <center><hr></center>
        </div>
        <div class="text-mark">
            ...
            <CENTER><img src="./img/mark-zuckerberg.jpg" alt=""></CENTER>
